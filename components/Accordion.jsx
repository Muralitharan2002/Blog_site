...
const Accordions = () => {
    ...
    const accordions = [
        ...
        {
            title: 'Edit easily',
            content: 'From simple and clean to glossy magazine – whatever your publishing style, the intuitive block editor adapts to you. Drag, drop, and easily swap out your menu, punch in a pull quote, or make your post pop with a beautiful gallery. Just like that.',
        },
        {
    ...
    return (
        <div className="relative flex items-center justify-between lg:flex-row sm:flex-col flex-col">
            ...
            <div className='lg:w-[43%] md:w-[70%] -z-10'>
                <Image src={blogImg} alt="" className='rounded-sm overflow-hidden max-w-full max-h-full my-3' />
            </div>
        </div>
    );
};
